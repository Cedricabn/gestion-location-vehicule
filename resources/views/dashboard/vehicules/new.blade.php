        ...
        <form action="{{ route('vehicules.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mt-4">
                <label class="block text-sm">
                    ...
                    <input
                        ...
                        placeholder="Mercedes Benz" name="name" required>
                </label>
            </div>
            ...
            <div class="mt-4">
                <label class="block text-sm">
                    ...
                    <input
                        class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                        placeholder="TOYOTA" name="marque"required >
                </label>
            </div>
            ...
            <div class="mt-4">
                <label class="block text-sm">
                    ...
                    <input type="number"
                        class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                        placeholder="200000FCFA/jour" name="prix" required>
                </label>
            </div>
            ...
            <div class="mt-4">
                <label class="block mt-4 text-sm">
                    ...
                    <textarea
                        ...
                        rows="3" placeholder="Véhicule luxieux" name="description" required></textarea>
                </label>
            </div>
            ...
            <div class="mt-4">
                <label class="block text-sm">
                    ...
                    <input type="file"
                        class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                        placeholder="200000FCFA/jour" name="image" required>
                </label>
            </div>
